...
pros_array.each do |j|
  ...
  until rubyist.turn == rubyist.num_turns
    move = false
    until move
      rubyist.rubies_found, rubyist.fake_rubies_found = \
        rubyist.find_rubies(mine.max_rubies, mine.max_fake_rubies)
